...
const ActiveSlider = () => {
    ...
    return (
        ...
        <div ref={contenedor} id='cards' className='h-[100vh] w-[80vw] m-auto relative flex justify-start items-center'>
            <div id='card-1' className='absolute left-0 top-0 -rotate-2 z-1 md:ml-20 md:left-[40px] lg:left-[50px]'>
            ...
            <div id='card-2' className='absolute left-0 top-[80px] rotate-1 z-5 md:ml-20 md:left-[80px] lg:left-[150px] lg:top-[40px]'>
            ...
            <div id='card-3' className='absolute left-0 top-[160px] -rotate-2 z-10 md:ml-20 md:left-[120px] lg:left-[250px] lg:top-[80px]'>
                <TestimonialCard name={'Tara Peck'}
                    testimonial={'Dr Horn and team are tremendous professionals.  I visited them with a persistent infection in an eye tooth, and over the course of the treatment it was completely cured.'}
                    initials={'T'}
                    bgColor={'bg-[#2a6b44]'} />
            </div>
            <div id='card-4' className='absolute left-0 top-[240px] rotate-2 z-20 md:ml-20 md:left-[160px] lg:left-[350px] lg:top-[120px]'>
            ...
            <div id='card-5' className='absolute left-0 top-[320px] -rotate-3 z-20 md:ml-20 md:left-[200px] lg:left-[450px] lg:top-[100px]'>
