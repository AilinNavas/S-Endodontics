...
export const TestimonialCard = ({ name, testimonial, initials, bgColor }) => {
    return (
        <div className='w-80 h-96 rounded-lg border-inherit font-sans shadow-lg border-gray border-1 bg-white'>
            <div className='bg-grey-300 rounded-t-md shadow-md shadow-top-left shadow-top-right w-full h-20 flex justify-center items-center text-3xl '>
