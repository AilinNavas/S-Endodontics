...
export const AreasOfService = () => {
  return (
    <div className='max-h-full mt-[20px] md:mt-0'>
      <h4 className='font-bold text-gray-dark h-1/5 text-xl font-roboto md:text-center underline underline-offset-4 mb-2 lg:mb-0'>Areas of Service</h4>
      <div className='grid grid-cols-2 h-4/5 '>
        {/* <ul className='grid grid-cols-1 gap-5 text-lg h-[80%] font-roboto'> */}
        <ul className='flex flex-col text-lg h-[80%] font-roboto'>
        ...
        <ul className='flex flex-col text-lg h-[80%] font-roboto ml-4'>
