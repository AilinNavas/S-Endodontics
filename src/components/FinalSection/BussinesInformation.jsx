...
export const BussinesInformation = () => {
    return (
        <div className='h-[90%]'>
            <h4 className='font-bold text-gray-dark h-1/5 text-xl font-roboto underline underline-offset-4 mb-2 lg:mb-0'>Bussines information</h4>
            <div className='flex flex-col h-4/5'>
                <div className='flex mb-2'>
                    <p className='font-bold font-roboto text-lg mr-1'>Address: </p>
                    <p className='font-roboto text-lg'> 1307 8th Ave #303,<br/> Fort Worth, TX</p>
                </div>
                <div className='flex mb-2'>
