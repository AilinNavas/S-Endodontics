    ...
    return (
        <section className='lg:pl-20'>
            ...
            <div ref={contenedor} className='h-[90vh] w-[90vw] mx-auto relative lg:w-[80vw] lg:h-[90vh] ' id="testimonials">
                ...
                <div id='card-3' className='absolute left-6 top-[160px] -rotate-2 z-10 md:top-[25vh] md:left-[25vw] lg:left-[20vw] lg:top-[10vh] '>
                ...
                <div id='card-6' className='sm:hidden lg:block lg:absolute lg:rotate-3 z-30 lg:ml-10 lg:left-[50vw] lg:top-[10vh]'>
                ...
                <div className='absolute w-[90vw] mx-auto bottom-4 lg:w-[80vw] lg:-bottom-10'>
