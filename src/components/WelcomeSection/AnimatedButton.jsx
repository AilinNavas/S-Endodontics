...
export const AnimatedButton = ({ text,link, backgroundColor, icon }) => {
  return (
    <button className={`cursor-pointer mx-2 font-semibold relative z-100 overflow-hidden border border-primary group px-8 py-2 hover:border-gray hover:scale-105 transition-all duration-00`}>
