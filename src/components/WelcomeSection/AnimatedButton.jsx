...
export const AnimatedButton = ({ text,link, backgroundColor, icon }) => {
  return (
    <button className={`cursor-pointer rounded-sm mx-1 font-semibold relative z-40 overflow-hidden shadow-lg border border-primary group px-6 py-2 hover:border-transparent hover:scale-105  transition-all duration-00`}>
