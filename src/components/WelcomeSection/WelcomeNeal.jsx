...
export const WelcomeNeal = () => {
  return (
    ...
    <div className="glowing-bg h-[85vh] lg:h-[65vh] w-[90vw] lg:w-[80vw] rounded-2xl bg-[#abb1b7] mx-auto flex items-center justify-center flex-col lg:flex-row lg:pl-10 shadow-lg">
      ...
      <div className="m-4 md:m-0 md:h-[50vh] lg:h-[45vh] z-10">
        <img
          src={nealHorn}
          alt=""
      ...
      <div className="lg:h-[60vh] lg:w-[55vw] flex flex-col items-center lg:flex-row">
        <div className="bg-white w-[75vw] h-[45vh] md:h-[35vh] flex flex-col justify-center -mt-[4vh] p-6 lg:w-[50vw] lg:h-[45vh] md:p-10 lg:-ml-4 lg:mt-0 rounded-lg shadow-lg z-0">
