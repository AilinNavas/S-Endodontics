...
export const WelcomeNeal = () => {
  return (
    <section className="lg:pl-20 lg:mt-40">
  
    <div className="h-[90vh] lg:h-[70vh] w-[90vw] lg:w-[80vw] bg-[#0e57b8] lg:rounded-2xl lg:bg-[#abb1b7] mx-auto flex items-center justify-center flex-col lg:flex-row lg:pl-10 lg:shadow-lg">
   
      <div className="md:h-[50vh] lg:h-[50vh]">
        <img
          src={nealHorn}
          alt=""
      ...
      <div className="lg:h-[60vh] lg:w-[55vw] flex flex-col items-center lg:flex-row">
        <div className="bg-white w-[75vw] h-[50vh] md:h-[35vh] flex flex-col justify-center -mt-[4vh] p-6 lg:w-[50vw] lg:h-[40vh] md:p-10 lg:-ml-[5vw] lg:mt-0 lg:rounded-2xl lg:shadow-lg">
