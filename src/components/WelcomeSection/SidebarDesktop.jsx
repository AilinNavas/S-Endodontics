...
export const SidebarDesktop = () => {
    ...
    return (
        ...
        >
            ...
            />
            <a href="#" onClick={handleCloseSidebar}><div className="flex gap-x-2 mt-4 items-center">
                <img
                    src={logoSrc}
            ...
            <ul className="pt-6">
                {MenuSider.map((menu, index) => (
                    <a href={`#${menu.id}`} onClick={handleCloseSidebar}>
                        <li
                            key={index}
