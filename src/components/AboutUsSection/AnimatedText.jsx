  ...
  return (
    <div ref={component} className="lg:w-1/2">
      <div ref={txtdiv} className="space-y-5 lg:mx-6">
        <h3
          ref={text}
          className="text-5xl text-[#0b4088] font-semibold font-zen py-6 md:text-6xl"
        >
          {title}
        </h3>
        <p
          ref={text}
          className="text-xl text-gray-dark font-normal font-roboto md:text-2xl lg:text-3xl"
        >
          {description}
        </p>
      </div>
